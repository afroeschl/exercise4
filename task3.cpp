...
/// @todo Implement function 'render_something' as declared and specified in
/// task3.hpp Implementation Hints:
///   - You can plot whatever you want, but you need to plot at least 20
///   primitives!
///   - You can view .svg-files using your web browser (or installing a VSCode
///   extension to preview SVGs)
///   - use the provided function 'task3::render_wrapper' from 'task3.misc.hpp'
///   to plot
///     task2::BBox, task2::Circle, task2::Triangle to a SVG-file
///   - The idea is that you make use of the functionality (scale/shift/rotate)
///   you implemented in task2
///   - Optional: you can make use of the random Generators in
///   'iue-rnd/random.hpp' to obtain random values, circles, and triangles
int render_something(std::filesystem::path filepath) {
    ...
    auto [bbmin, bbmax] =
        task3::render_wrapper(filepath, bboxes, circles, triangles);
